          ...
          "quiz": [
            {
              ...
              "opts": ["Integrity; Active attack", "Confidentiality; Passive attack", "Availability; Active attack", "Authenticity; Passive attack"],
              "ans": 1,
              "cat": "CIA / Attacks",
              "correctFb": "Reading data violates Confidentiality. Because transmitted bits remain untouched, it is a Passive attack.",
              "distractors": ["Integrity requires data tampering.", "Availability relates to denial of service.", "Authenticity relates to identity spoofing."]
            },
            {
              "q": "Which of the following is an ACTIVE attack?",
              "opts": ["Eavesdropping on HTTP", "Traffic Analysis", "Replay Attack", "Port scanning without payloads"],
              "ans": 2,
              "cat": "Attacks",
              "correctFb": "Replay attacks inject captured packets into the network to alter state or duplicate effects.",
              "distractors": ["Eavesdropping is passive.", "Traffic analysis is passive observation.", "Port scanning is passive reconnaissance."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Pre-image resistance", "Second pre-image resistance", "Collision resistance", "Strict avalanche criterion"],
              "ans": 2,
              "cat": "Cryptography",
              ...
              "distractors": ["Pre-image resistance is one-wayness (given y, find x).", "Second pre-image means given x, find y != x with H(x)==H(y).", "Avalanche is bit flipping."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Transport Mode", "Tunnel Mode", "Pass-through Mode", "Bridge Mode"],
              "ans": 1,
              "cat": "Network Security",
              ...
              "distractors": ["Transport mode only protects payload and keeps the original IP header.", "Pass-through is not an IPsec mode.", "Bridge is Layer 2."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Reflected XSS", "Stored (Persistent) XSS", "DOM-based XSS", "Blind SSRF"],
              "ans": 1,
              "cat": "Web Security",
              ...
              "distractors": ["Reflected XSS requires the victim to click a malicious link.", "DOM-based XSS executes purely in client scripts.", "SSRF is server-side request forgery."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Section 43", "Section 66", "Section 66A", "Section 65"],
              "ans": 2,
              "cat": "Cyber Laws",
              ...
              "distractors": ["Section 43 covers civil damage to computer systems.", "Section 66 covers hacking.", "Section 65 covers tampering with source documents."]
            }
          ]
        }
      ]
          ...
          "quiz": [
            {
              ...
              "opts": ["Monolithic Kernel", "Microkernel", "Layered Kernel", "Hybrid Kernel"],
              "ans": 1,
              "cat": "Architecture",
              "correctFb": "Microkernels keep the kernel minimal for fault isolation, moving servers into user space.",
              "distractors": ["Monolithic executes everything in kernel space.", "Layered is hierarchical.", "Hybrid combines both."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Starvation", "Convoy Effect", "Belady's Anomaly", "Priority Inversion"],
              "ans": 1,
              "cat": "Scheduling",
              "correctFb": "The Convoy Effect describes short processes queued behind a CPU-heavy process.",
              "distractors": ["Starvation is indefinite postponement.", "Belady's anomaly affects FIFO page replacement.", "Priority inversion affects synchronization."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Mutual Exclusion", "Circular Wait", "Preemptible Resources", "Hold and Wait"],
              "ans": 2,
              "cat": "Deadlocks",
              "correctFb": "The condition is NO PREEMPTION. Allowing preemptible resources actually prevents deadlock.",
              "distractors": ["Mutual exclusion is necessary.", "Circular wait is necessary.", "Hold and wait is necessary."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Least Recently Used (LRU)", "First-In, First-Out (FIFO)", "Optimal Page Replacement (OPT)", "LFU"],
              "ans": 1,
              "cat": "Memory",
              ...
              "distractors": ["LRU is immune to Belady's anomaly.", "OPT is immune to Belady's anomaly.", "LFU is a frequency algorithm."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "distractors": ["SCAN services requests in both directions.", "SSTF chooses the closest request.", "LOOK reverses at the last request instead of the edge."]
            }
          ]
        }
      ]
          ...
          "quiz": [
            {
              ...
              "distractors": ["Switches operate at Data Link.", "Transport handles ports.", "Physical handles raw bits."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["2^m", "2^m - 1", "2^(m-1)", "m"],
              "ans": 1,
              "cat": "Data Link",
              "correctFb": "In Go-Back-N, the sender window size cannot exceed 2^m - 1 to prevent ambiguity between duplicate and new ACKs.",
              "distractors": ["2^m causes ambiguity.", "2^(m-1) is the window limit for Selective Repeat.", "m is the bit width."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Bellman-Ford Algorithm", "Dijkstra's Algorithm", "Floyd-Warshall Algorithm", "Kruskal's Algorithm"],
              "ans": 1,
              "cat": "Routing",
              "correctFb": "OSPF and Link State routing use Dijkstra's shortest-path algorithm to calculate least-cost paths.",
              "distractors": ["Bellman-Ford is used by Distance Vector (RIP).", "Floyd-Warshall finds all-pairs shortest paths.", "Kruskal is for Minimum Spanning Trees."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Linearly by 1 MSS", "Exponentially (doubling every RTT)", "Logarithmically", "It remains constant"],
              "ans": 1,
              "cat": "Transport",
              "correctFb": "Slow Start increases cwnd exponentially (doubles each RTT) until the slow-start threshold (ssthresh) is reached.",
              "distractors": ["Linear increase occurs during Congestion Avoidance.", "Logarithmic is incorrect.", "Constant window occurs in flow control saturation."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["A Record", "AAAA Record", "CNAME Record", "PTR Record"],
              "ans": 1,
              "cat": "Application",
              "correctFb": "AAAA records map domain names to 128-bit IPv6 addresses (whereas A records map to 32-bit IPv4).",
              "distractors": ["A Record is IPv4.", "CNAME is an alias.", "PTR is reverse DNS lookup."]
            }
          ]
        }
      ]
          ...
          "quiz": [
            {
              ...
              "opts": ["Simple Reflex Agent", "Model-Based Reflex Agent", "Table-Driven Agent", "Pure Reactive Agent"],
              "ans": 1,
              "cat": "Agents",
              "correctFb": "Model-based reflex agents keep track of the world state using an internal model of how the environment evolves.",
              "distractors": ["Simple reflex ignores history.", "Table-driven is completely impractical.", "Pure reactive has no memory."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["It becomes Breadth-First Search (BFS)", "It degrades into Uniform Cost Search (Dijkstra)", "It becomes Greedy Best-First Search", "It fails to find any solution"],
              "ans": 1,
              "cat": "Search",
              "correctFb": "When h(n) = 0, f(n) = g(n), which evaluates purely based on path cost from the start node (Uniform Cost Search).",
              "distractors": ["BFS assumes all step costs are equal.", "Greedy search only uses h(n).", "It still finds the optimal path."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["The knowledge base is incomplete", "A contradiction is reached, proving the original query", "The query is undecidable", "The search algorithm looped indefinitely"],
              "ans": 1,
              "cat": "Logic",
              "correctFb": "Deriving the empty clause proves that KB and ~alpha is unsatisfiable (a contradiction), confirming KB |= alpha.",
              "distractors": ["Incompleteness is false.", "Undecidability is not signaled by an empty clause.", "Looping does not produce an empty clause."]
            }
          ]
        }
      ]
          ...
          "quiz": [
            {
              ...
              "opts": ["Yes, NFAs can recognize context-free languages", "No, NFAs and DFAs recognize the exact same class of Regular Languages", "Yes, because of epsilon transitions", "No, DFAs are strictly more powerful than NFAs"],
              "ans": 1,
              "cat": "Automata",
              "correctFb": "NFAs and DFAs have identical computational power; both recognize precisely the regular languages.",
              "distractors": ["Neither recognizes non-regular CFLs.", "Epsilon transitions do not add expressive power.", "DFAs are not strictly more powerful."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["|y| > 0", "|xy| <= p", "for all i >= 0, xy^i z in L", "|z| <= p"],
              "ans": 3,
              "cat": "Regular Languages",
              "correctFb": "There is no constraint on the length of z (|z| <= p). The constraints are |y| > 0 and |xy| <= p.",
              "distractors": ["|y| > 0 is mandatory.", "|xy| <= p is mandatory.", "xy^i z in L is mandatory."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Any computable function can be computed by a Turing Machine", "Turing machines can solve the Halting Problem", "DFAs are equivalent in power to Turing Machines", "Quantum computers violate all Turing limits"],
              "ans": 0,
              "cat": "Computability",
              ...
              "distractors": ["The Halting Problem is undecidable by TMs.", "DFAs are strictly less powerful than TMs.", "Quantum computers do not expand computability classes."]
            }
          ]
        }
      ]
          ...
          "quiz": [
            {
              ...
              "opts": ["git merge", "git rebase", "git checkout", "git stash"],
              "ans": 1,
              "cat": "VCS",
              "correctFb": "git rebase reapplies commits on top of another base tip, creating a linear history.",
              "distractors": ["git merge creates a merge commit.", "checkout switches branches.", "stash saves uncommitted changes."]
            }
          ]
        },
        {
          ...
          "quiz": [
            {
              ...
              "opts": ["Containers share the host OS kernel; VMs run separate guest OS kernels via a hypervisor", "VMs are lighter and boot faster than containers", "Containers do not support networking", "Containers require dedicated BIOS firmware"],
              "ans": 0,
              "cat": "Containers",
              ...
              "distractors": ["Containers boot much faster than VMs.", "Containers have full virtual networking.", "Containers do not use virtual BIOS."]
            }
          ]
        }
      ]
...
print(f"Generated comprehensive curriculum with {len(curriculum['subjects'])} subjects.")
for s in curriculum['subjects']:
    mod_count = len(s['modules'])
    topic_count = sum(len(m['topics']) for m in s['modules'])
    quiz_count = sum(len(m['quiz']) for m in s['modules'])
    print(f" - {s['icon']} {s['title']} ({s['code']}): {mod_count} modules, {topic_count} topics, {quiz_count} MCQs")
